...
public class PropertyText extends OrderedProperties
{
	...
	public PropertyText(CompilerConfiguration configuration, SymbolTable symbolTable, Source source, String locale)
	{
		super();
		...
		imports.add("mx.resources.ResourceBundle");
    ...
    private ClassReference processClassReference(String key, String value)
    {
        ...
        int lineNumber = ((Integer) lines.get(key)).intValue();
