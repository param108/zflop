...
public class XLRLocalizer implements ILocalizer
{
    ...
    public XLRTargetNode loadNode( Locale fileLocale, String fileId, Locale locale, String id )
    {
        ...
        XLRFile f = (XLRFile) filedict.get( key );
    ...
    private abstract class XLRNode
    {
        ...
        public boolean execute( StringBuffer buffer, String locale, Map parameters )
        {
            boolean success = false;
            for (Iterator it = children.iterator(); it.hasNext(); )
            {
                XLRNode child = (XLRNode) it.next();
    ...
    private class XLRHandler extends DefaultHandler
    {
        ...
        StringBuffer textBuffer = new StringBuffer(128);
        ...
        throws SAXException
        {
            ...
            else if ("message".equals( qName ))
            {
                ...
                node = (XLRMessageNode) nodedict.get( id );
                if (node == null)
                {
