...
public class I18nUtils
{
    ...
    {        
        ...
        String[] codePieces = new String[]
        {
            ...
            "import mx.modules.ModuleBase;", lineSep,
            "import mx.resources.IResourceModule;", lineSep,
            "import mx.resources.ResourceBundle;", lineSep,
            lineSep,
            "[ExcludeClass]", lineSep, lineSep,
	...
	private static String codegenResourceBundleClassNames(String[] locales, List bundleNames)
	{
		...
		for (int i = 0; i < locales.length; i++)
		{
			...
			for (Iterator iter = bundleNames.iterator(); iter.hasNext(); )
			{
