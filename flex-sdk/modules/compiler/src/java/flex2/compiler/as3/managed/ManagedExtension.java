...
public final class ManagedExtension extends GenerativeExtension
{
	 ...
	 *
	 */
	public ManagedExtension(String generatedOutputDirectory)
	{
		this(generatedOutputDirectory, null);
	}

    public ManagedExtension(String generatedOutputDirectory, ServicesDependencies services)
    {
        super(generatedOutputDirectory);
    ...
    protected void addInheritance(CompilationUnit unit)
    {
        ...
        unit.inheritance.add(new MultiName(StandardDefs.PACKAGE_MX_DATA, IMANAGED));
    }
	...
	protected GenerativeFirstPassEvaluator getFirstPassEvaluator(CompilationUnit unit,
                                                                 TypeTable typeTable)
	{
		return new ManagedFirstPassEvaluator(typeTable, unit.metadata, servicesDependencies);
	}
