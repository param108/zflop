...
/**
 * This implementation of FontManager uses Apache Batik to process TrueTypeFont Files.
 *
...
public class BatikFontManager extends CachedFontManager
{
    ...
    public void initialize(Map map)
    {
        ...
        initializeMap = map;
        String s = (String) map.get(CachedFontManager.COMPATIBILITY_VERSION);
        keep201Behavior = "2.0.1".equals(s) || "2.0.0".equals(s) || "2.0".equals(s);
    }
    ...
    public FontFace getEntryFromLocation(URL location, int style, boolean useTwips)
    {
    	...
    	{
        	return (parent != null) ? parent.getEntryFromLocation(location, style, useTwips) : null;
    	}
        ...
        else if (parent != null)
        {
        	...
        	return parent.getEntryFromLocation(location, style, useTwips);
        }
        ...
        if (path != null)
        {
            try
            {
                ...
                if (font != null)
                {
                    ...
                    // style property...
                    BatikFontFace fontFace = new BatikFontFace(font, 0, maxGlyphsPerFace, type, copyright, trademark, useTwips, keep201Behavior);
...
//            }
        ...
        private void readPoints(Glyph glyph)
        {
            ...
            ArrayList aSegments = new ArrayList(count);
            Point lastMove = null;
...
//                  !!! Laurie's change. Handle off-curve/off-curve/end. There is
            ...
            segments = (double[][])aSegments.toArray(segments);
        }
