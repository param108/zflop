...
//	public int			getOffsetCount() 		{ swdLoading(); return m_offsetCount; }
	...
	public void freshen(long id, String path, String url, String host, long port, boolean swdLoading, long swfSize, long swdSize, long bpCount, long offsetCount, long scriptCount, IntMap map, int minId, int maxId)
	{
		m_id = (int)id;
		m_path = path;
		m_url = url;
	 ...
	 * 
	 */
	int local2Global(int id)
	{
		Integer g = (Integer)m_local2Global.get(id);
		if (g != null)
			id = g.intValue();
