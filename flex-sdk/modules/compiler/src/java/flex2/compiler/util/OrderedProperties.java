...
/**
 * Properties extension that reads properties in Unicode and uses a Vector to maintain keys
 * in order.
 */
public class OrderedProperties extends Properties implements Serializable
{
    ...
    private void store2(PrintWriter out, String header) {
        ...
        for(Enumeration ke = keys.elements();
            ke.hasMoreElements();) {
...
//                      buffer.append(current);
	...
	public class MalformedEncoding extends CompilerMessage.CompilerError
	{
