...
/**
 * A face represents one style of a font from a single family. For now, the font size
 * is not considered in the face as a FontBuilder does not depend on size to generate
 * a DefineFont or DefineFont2 tag.
 *
