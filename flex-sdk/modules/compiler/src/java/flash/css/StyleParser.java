...
public class StyleParser
{
		...
		try
		{
			...
			ErrorHandler errorHandler = new ErrorHandler() {
				public void error(CSSParseException exception) throws CSSException
				{
                    if (mxmlPath != null)
                    {
                        handler.logError(mxmlPath, mxmlLineNumber + exception.getLineNumber(),
				...
				public void warning(CSSParseException exception) throws CSSException
				{
                    if (mxmlPath != null)
                    {
                        handler.logWarning(mxmlPath, mxmlLineNumber + exception.getLineNumber(),
                                        StyleParserErrorTranslator.getUserFriendlyErrror(exception.getMessage()));
                    }
                    else
                    {
	...
	public void warnDeprecation(String deprecated, String replacement, int lineNumber)
	{
        ...
        if (mxmlPath != null)
        {
            messageHandler.logWarning(mxmlPath, mxmlLineNumber + lineNumber, message);
        }
        else
        {
	...
	public void warning(CSSException cssException)
	{
        ...
        if (mxmlPath != null)
        {
            ...
            messageHandler.logWarning(mxmlPath, mxmlLineNumber + lineNumber,
	...
	public void error(CSSException cssException)
	{
        ...
        {
            int lineNumber = parser.getLineNumber();
            messageHandler.logError(mxmlPath, mxmlLineNumber + lineNumber,
                                 StyleParserErrorTranslator.getUserFriendlyErrror(cssException.getMessage()));
        }
        else
        {
